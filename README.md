...
<div style="display: flex; justify-content: center; gap: 20px;">
  <div style="text-align: center;">
    <img src="./img/mnist_dlpm_1.7.png" alt="MNIST" style="width: 250px; display: inline-block;"/>
    <p>MNIST (DLPM)</p>
  </div>
  <div style="text-align: center;">
    <img src="./img/cifar10_lt_dlpm_1.7.png" alt="CIFAR10_LT" style="width: 250px; display: inline-block;"/>
    <p>CIFAR10_LT (DLPM)</p>
  </div>
</div>
